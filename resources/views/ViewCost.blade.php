                            ...
                            <div class="col-sm-12 col-md-9 cmp-pnl">
                                ...
                                <div id="main_information">
                                    <div class="col-xs-12 col-sm-4 cmp-pnl">
                                        <div class="inner-cmp-pnl">
                                            <input type="text" class="form-control" style="color: #2a27b0;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Water Consumption Total (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            ...
                                            <input type="text" class="form-control" style="color: #2a27b0;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Gas Consumption Total (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            <div style="height: 15%;border: 1px solid;border-color: #ffe2ca;background-color: #f5f8f8;border-radius: 10px">
                                                <div  style="position: relative; width: 30%; display: inline; float: left;">
                                                    <div style="width: 100%; height: 33%; position: relative;">
                                                        <span style="position: absolute;top: 50%; left:5%; transform: translateY(-50%)">this: </span>
                                            ...
                                            <input type="text" class="form-control" style="color: #2a27b0;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Electrical Energy Consumed (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            <div style="height: 15%;border: 1px solid;border-color: #ffe2ca;background-color: #f5f8f8;border-radius: 10px">
                                                <div  style="position: relative; width: 30%; display: inline; float: left;">
                                                    <div style="width: 100%; height: 33%; position: relative;">
                                                        <span style="position: absolute;top: 50%; left:5%; transform: translateY(-50%)">this: </span>
                                    ...
                                    <div class="col-xs-12 col-sm-4 cmp-pnl">
                                        <div class="inner-cmp-pnl">
                                            <input type="text" class="form-control" style="color: #bc1218;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Produced By Solar Panel (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            ...
                                            <input type="text" class="form-control" style="color: #7e5061;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Heating and Hot Water (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            <div style="height: 15%;border: 1px solid;border-color: #ffe2ca;background-color: #f5f8f8;border-radius: 10px">
                                                <div  style="position: relative; width: 30%; display: inline; float: left;">
                                                    <div style="width: 100%; height: 33%; position: relative;">
                                                        <span style="position: absolute;top: 50%; left:5%; transform: translateY(-50%)">this: </span>
                                            ...
                                            <input type="text" class="form-control" style="color: #bc1218;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Cooker Energy Total (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            <div style="height: 15%;border: 1px solid;border-color: #ffe2ca;background-color: #f5f8f8;border-radius: 10px">
                                                <div  style="position: relative; width: 30%; display: inline; float: left;">
                                                    <div style="width: 100%; height: 33%; position: relative;">
                                                        <span style="position: absolute;top: 50%; left:5%; transform: translateY(-50%)">this: </span>
                                    ...
                                    <div class="col-xs-12 col-sm-4 cmp-pnl">
                                        <div class="inner-cmp-pnl">
                                            ...
                                            <input type="text" class="form-control" style="color: #965c74;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Lighting Energy Total (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            ...
                                            <input type="text" class="form-control" style="color: #865769;text-align: center;margin-bottom: 5%;margin-top: 15px" value="Kitchen Sockets Energy Total (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            <div style="height: 15%;border: 1px solid;border-color: #ffe2ca;background-color: #f5f8f8;border-radius: 10px;padding-top: 0%">
                                                <div  style="position: relative; width: 30%; display: inline; float: left;">
                                                    <div style="width: 100%; height: 33%; position: relative;">
                                                        <span style="position: absolute;top: 50%; left:5%; transform: translateY(-50%)">this: </span>
                                            ...
                                            <input type="text" class="form-control" style="text-align: center;margin-bottom: 5%;margin-top: 15px" value="Combined Energy Total (£)" id="e_Electrical" name="e_Electrical" required="required" aria-required="true" disabled>
                                            <div style="height: 15%;border: 1px solid;border-color: #ffe2ca;background-color: #f5f8f8;border-radius: 10px;padding-top: 0%">
                                                <div  style="position: relative; width: 30%; display: inline; float: left;">
                                                    <div style="width: 100%; height: 33%; position: relative;">
                                                        <span style="position: absolute;top: 50%; left:5%; transform: translateY(-50%)">this: </span>
